...
function postCategoria(){
    ...
    if ($("#name").val().length==0 || $("#description").val().length==0 ){
        ...
        $.ajax({
            url:"http://152.67.41.118:8080/api/Category/save",
            type:"POST",
            datatype:"JSON",
            ...
            success:function(respuesta){
                ...
                Swal.fire('Se creo correctamente la categoria');
    ...
    if ($("#name").val().length==0 || $("#description").val().length==0 ){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url:"http://152.67.41.118:8080/api/Category/update",
                    type:"PUT",
                    datatype:"JSON",
...
function deleteCategoria(idBotonBorrar){
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url:"http://152.67.41.118:8080/api/Category/"+ idBotonBorrar,
                type:"DELETE",
                datatype:"JSON",
